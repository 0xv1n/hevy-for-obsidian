...
var HevySettingTab = class extends import_obsidian.PluginSettingTab {
...
// src/utils.ts
function convertWeight(weightKg, unit) {
  if (weightKg === null)
    return 0;
...
var ExerciseSuggestModal = class extends import_obsidian3.SuggestModal {
  ...
  getSuggestions(query) {
    return this.exercises.filter(
      (ex) => ex.toLowerCase().includes(query.toLowerCase())
    );
  }
  renderSuggestion(ex, el) {
    el.createEl("div", { text: ex });
  }
  onChooseSuggestion(ex, evt) {
    this.onChoose(ex);
  }
};
    ...
    for (const file of folder.children) {
      if (file instanceof import_obsidian4.TFile && file.extension === "md") {
        ...
        if (dateMatch) {
          ...
          if (!workoutsByWeek[weekStr])
            workoutsByWeek[weekStr] = [];
